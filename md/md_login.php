...
<form name="frm" action="<?=$ssl?>/md/md_check.php" method="post" onSubmit="return inputCheck(this);">
<div class="AW-admin-login_wrap">
    ...
    <div class="form">
    	...
    	<dl>
        	<dt>PASSWORD</dt>
            <dd><input type="password" name="admin_pw" value="qwe123qwe" placeholder="비밀번호를 입력하세요" /></dd>
        </dl>
        <?=$hide_ssl_start?>
