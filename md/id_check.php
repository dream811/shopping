...
if($strID != ""){
	if($total > 0){
		$checkmsg = "<font color=#00BCBC><b>".$strID."</b></font> 는 이미 사용중인 아이디 입니다.";
	} else if($total2 + $total3 > 0) {
		$checkmsg = "<font color=#00BCBC><b>".$strID."</b></font> 는 사용할 수 없는 아이디 입니다.";
	} else{
		$checkmsg = "<font color=#00BCBC><b>".$strID."</b></font> 는 사용가능한 아이디 입니다. <a class='AW-btn' onCLick='setId()'>사용하기</a>";
	}
}else{
	$checkmsg = "사용하고자 하는 아이디 입력하세요";
}
?>
<html>
<head>
