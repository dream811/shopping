...
<title>::::: MD회원 관리자:::::</title>
<link href="/md/style.css" rel="stylesheet" type="text/css">
...
<div class="AW-manage-head">
	<ul class="topmenu" style="left:10px;">
    	<li><a ><?=$wiz_md['name']?></a><i></i></li>
    	<li><a >골드회원</a><i></i></li>
    	<li><a style="display:none;"></a><i></i></li>
    </ul><!-- .topmenu -->
    <ul class="topmenu">
    	<li><a href="http://<?=$HTTP_HOST?>" target="_blank">내 쇼핑몰</a><i></i></li>
    	<li><a href="../main/main.php">관리자 메인</a><i></i></li>
    	<li><a href="../md_logout.php">로그아웃</a><i></i></li>
    </ul><!-- .topmenu -->
</div><!-- .AW-manage-head -->
...
<div class="AW-manage-navi">
	...
	<ul>
        ...
        <li class="<?=$navi6?>"><a href="../member/member_list.php">회원관리</a></li>
        <li class="<?=$navi13?>"><a href="../md/md_list.php">하부MD회원관리</a></li>
