...
$sql = "select * from tb_users where strId = '".$wiz_md['id']."'";
...
-->
			...
			<table border="0" cellspacing="0" cellpadding="2">
			  <tr>
			    ...
			    <td width="2"></td>
			    <td valign="bottom" class="tit_alt">MD회원 기본정보를 설정합니다.</td>
			  </tr>
			</table>
          ...
          <td>
            <table width="100%" border="0" cellspacing="1" cellpadding="6" class="t_style">
              <tr>
                ...
                <td width="35%" class="t_value"><input name="id" type="text" value="<?=$mall_info->strID?>" class="input" readonly></td>
                <td width="15%" class="t_name">비밀번호</td>
                <td width="35%" class="t_value"><input name="passwd" type="text" value="<?=$mall_info->password?>" class="input"></td>
              </tr>
              <tr>
                <td align="left" class="t_name">이름</td>
