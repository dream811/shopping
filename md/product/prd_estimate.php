...
//-->
    	...
    	$sql = "select wb.idx from wiz_bbs as wb left join wiz_product as wp on wb.prdcode = wp.prdcode
    					where wb.code='$code' and wb.prdcode != '' and wp.mallid = '".$wiz_md['id']."'";
      ...
      $all_total = mysqli_num_rows($result);
			...
			$sql = "select wb.idx from wiz_bbs as wb, wiz_product as wp where wb.code='$code' and wb.prdcode = wp.prdcode and wp.mallid = '".$wiz_md['id']."' $search_sql order by wb.wdate desc";
			$result = mysqli_query($connect, $sql) or die(mysqli_error($connect));
      ...
      <?
			$sql = "select wb.*, from_unixtime(wb.wdate) as wdate, wp.prdimg_R, wp.prdname from wiz_bbs as wb, wiz_product as wp where wb.code='$code' and wb.prdcode = wp.prdcode and wp.mallid = '".$wiz_md['id']."' $search_sql order by wb.wdate desc limit $start, $rows";
			$result = mysqli_query($connect, $sql) or die(mysqli_error($connect));
