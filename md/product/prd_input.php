            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="2" class="t_style">
                ...
                <td class="t_value">
                	<select name="mallid" onChange="setCmsRate();">
                		<?php
                		$sql = "select id, com_name, cms_type, cms_rate from wiz_mall where status = 'Y' and id = '".$wiz_md['id']."' order by com_name asc";
                		$result = mysqli_query($connect, $sql) or die(mysqli_error($connect));
              ...
              <tr>
                ...
                <td class="t_value" colspan="3">
                  <input type="checkbox" name="new" value="Y" <? if(isset($prd_row->new) && $prd_row->new == "Y") echo "checked"; ?>><img src="/images/icon_new.gif" border="0"> &nbsp;
                  <input type="checkbox" name="best" value="Y" <? if(isset($prd_row->best) && $prd_row->best == "Y") echo "checked"; ?>><img src="/images/icon_best.gif" border="0"> &nbsp;
                  <input type="checkbox" name="popular" value="Y" <? if(isset($prd_row->popular) && $prd_row->popular == "Y") echo "checked"; ?>><img src="/images/icon_hit.gif" border="0"> &nbsp;
                  <input type="checkbox" name="recom" value="Y" <? if(isset($prd_row->recom) && $prd_row->recom == "Y") echo "checked"; ?>><img src="/images/icon_rec.gif" border="0"> &nbsp;
                  <input type="checkbox" name="sale" value="Y" <? if(isset($prd_row->sale) && $prd_row->sale == "Y") echo "checked"; ?>><img src="/images/icon_sale.gif" border="0"> &nbsp;
                </td>
              </tr>
              <tr>
