...
<?
if($prdcode != ""){
	$rel_sql = "select wr.idx,wp.prdcode,wp.prdname,wp.prdimg_R from wiz_prdrelation wr, wiz_product wp where wr.prdcode = '$prdcode' and wr.relcode = wp.prdcode and wp.mallid = '".$wiz_md['id']."'";
