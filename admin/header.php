...
$pageNum=10; $pageTxt="정산관리";

} else if(strpos($_SERVER['PHP_SELF'],"/mall/")!==false){
$pageNum=9; $pageTxt="입점업체 관리";
...
<div class="Topmenu-wrap clearfix">
    <ul class="gnb clearfix">
    	...
    	<li><a href="http://scrap.<?=$HTTP_HOST?>/loginCheckFromShop?strId=michael&pwd=qwe123qwe" target="_blank">스크랩</a></li>
